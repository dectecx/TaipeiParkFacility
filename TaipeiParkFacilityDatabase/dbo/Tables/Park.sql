...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'行政區', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'Park', @level2type = N'COLUMN', @level2name = N'DictName';
